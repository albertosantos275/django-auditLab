...
def compute_agregates(ref_sheet):
    ...
    by_client= de14_agregates.agregate_by_client_type(ref_sheet,24,6,0, 50,2, client_types)
    by_person= de14_agregates.agregate_by_person_type(ref_sheet,2,6,0, 25,2, person_types)
    # #ref_sheet, row_name, key_col, amount_col, 
    # #max_col_number,row_number, codes
    by_vinculacion = de14_agregates.agregate_by_single_col(ref_sheet,'name',14,6,32,2, vinculacion_type)
    by_origin = de14_agregates.agregate_by_single_col(ref_sheet,'name',31,6,40,2, origin_resources)
    by_province  = de14_agregates.agregate_by_provinces(ref_sheet,23,6,0, 34,2, localidades)
    by_average  = de14_agregates.agregate_by_average(ref_sheet,1,6,3,4,0,25,2)
