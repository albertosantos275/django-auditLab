...
def agregate_by_person_type(ref_sheet,type_col, amount_col, min_col_number, max_col_number,row_number, codes, filter_val): 
    data={
    }
    risk_data={
        # "Alto":{"total":0},
...
def agregate_by_single_col(ref_sheet, row_name, key_col, amount_col, 
    max_col_number,row_number, codes,filter_val, ignore_key= False): 
    data={
    }
    total = 0
    def init_data(k, data):
